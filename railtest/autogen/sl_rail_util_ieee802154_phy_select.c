...
#define RUNTIME_PHY_SELECT (0 || SL_RAIL_UTIL_ANT_DIV_RX_RUNTIME_PHY_SELECT)

#define RUNTIME_PHY_SELECT_STACK_SUPPORT (0)
...
static sl_rail_util_ieee802154_radio_config_t sl_rail_util_get_desired_radio_config(void)
{
  return (SL_RAIL_UTIL_IEEE802154_RADIO_CONFIG_2P4_DEFAULT
          | (sl_rail_util_ant_div_get_phy_select() ? SL_RAIL_UTIL_RADIO_CONFIG_154_2P4_ANTDIV: SL_RAIL_UTIL_IEEE802154_RADIO_CONFIG_2P4_DEFAULT)
  );
}
