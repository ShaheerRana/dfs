...
void config863MhzSUNOFDMOpt(sl_cli_command_arg_t *arguments);
void config902MhzSUNOFDMOpt(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd__config863MhzSUNOFDMOpt = \
  SL_CLI_COMMAND(config863MhzSUNOFDMOpt,
                 " Configure the radio for 863-876 MHz SUN OFDM modulations",
                  "ofdmOption: 1-2-3-4" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__config902MhzSUNOFDMOpt = \
  SL_CLI_COMMAND(config902MhzSUNOFDMOpt,
                 " Configure the radio for 902-928 MHz SUN OFDM modulations",
                  "ofdmOption: 1-2-3-4" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd__set802154PHR = \
  SL_CLI_COMMAND(ieee802154SetPHR,
                 "Set PHR (first 1, 2 or 4 bytes) in Tx buffer according to\n                      the 'format' input parameter.\n                    PHR 'frameLength' field is derived from TxLength set\n                      previously with 'setTxLength'\n                    For PHR fields info, refer to 802.15.4 specification.",
                  "PHR format : 0=misc IEEE802154 modulations, PHR 1byte\n                                         1=SUN FSK, PHR 2bytes\n                                         2=SUN OFDM, PHR 4bytes\n                                         3=SUN OQPSK, PHR 4bytes" SL_CLI_UNIT_SEPARATOR "For SUN_OFDM : rate\n                               For SUN_OQPSK: spreadingMode\n                               For SUN_FSK  : fcsTtype\n                               For LEG_OQPSK: none\n                    [uint8opt] For SUN_OFDM : scrambler\n                               For SUN_OQPSK: rateMode\n                               For SUN_FSK  : whitening\n                               For LEG_OQPSK: none" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8OPT, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__trigModeSwitchTx = \
  SL_CLI_COMMAND(trigModeSwitchTx,
                 "Transmit a Mode Switch packet then transmit packets on the new PHY with current TX options and stay on the new PHY.",
                  "new PhyModeId, i.e. ID of the PHYMode we are switching to" SL_CLI_UNIT_SEPARATOR "number of packets transmitted on the new PHY" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd__enableBleSignalIdentifier = \
  SL_CLI_COMMAND(enableBleSignalIdentifier,
                 " Enable Signal Identifier for BLE signal detection",
                  "0=Disable 1=Enable" SL_CLI_UNIT_SEPARATOR "Mode 1=BLE1Mbps 2=BLE2Mbps" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "config863MhzSUNOFDMOpt", &cli_cmd__config863MhzSUNOFDMOpt, false },
  { "config902MhzSUNOFDMOpt", &cli_cmd__config902MhzSUNOFDMOpt, false },
